...
public class ReservationController {
    ...
    public List<GetReservationRes> getMyReservations(@LoginMember MemberDTO memberDTO,
                                                     @Parameter(description = "방문 상태", required = true) @PathVariable ReservationStatus status) {
